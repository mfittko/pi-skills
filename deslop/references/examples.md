...
## Example 15: Softened Contrast Pair (General)

**Before:**
> "AI can make code generation cheaper. It does not make coordination cheap."

**After:**
> "AI lowers the cost of code generation. Coordination still carries a high cost."

**Changes:** Removed the contrast-pair skeleton. Kept the distinction, but stated both claims directly instead of using a setup-and-negation rhythm.

---

## Example 16: "Imagine a World" + Patronizing Analogy (General)

**Before:**
> "Imagine a world where every meeting had a clear agenda. Think of it like a recipe: you wouldn't start cooking without knowing the ingredients. Why this matters: async-first communication works better when people know the point of the meeting before they join."
...
**Changes:** Removed the "imagine" opener, the cooking analogy, and the generic explainer heading. Replaced them with a specific claim, a number, and the mechanism that makes agendas work.
