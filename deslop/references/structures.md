...
| "X can do A. It can't do B." | Same contrast pattern with milder wording |
| "X lowers A. It does not lower B." | Negation-by-contrast disguised as nuance |
| "X helps with A. B still remains." | Setup + denial + reveal in softer language |
| "This is X, not just Y." | Same contrast move dressed up as emphasis |

**Fix:** State Y directly. "The problem is Y." Drop the negation entirely. If you need a two-part claim, make both clauses positive and specific: "AI lowers the cost of code generation. Coordination still carries a high cost." instead of "AI can make code generation cheaper. It does not make coordination cheap." And instead of "This is a pitch, not just an implementation plan," say what the document does: "This epic is meant to support a pitch and to break the work into follow-up artifacts."

## Balanced Concession Then Abstract Takeaway

A polished two-step move that grants reasonableness in sentence one, then lands on an abstract noun in sentence two. It reads like debate-club prose engineered to sound fair, quotable, and finished.

| Pattern | Problem |
|---------|---------|
| "Either answer is workable. The ambiguity is the problem." | Neat symmetry, abstract conclusion |
| "Either path could work. What matters is clarity." | Generic concession plus vague takeaway |
| "I can live with either outcome. The real issue is trust." | Screenshot-friendly cadence |
| "Both models are viable. The tension is in the transition." | Abstract noun doing the work |

**Fix:** Say what you actually need in concrete terms. Name the actor, decision, or missing commitment. "I can work with either model. I need OpenAI to say which one it intends to support." beats "Either answer is workable. The ambiguity is the problem."
...
| Balanced concession + abstract noun ("Either answer is workable. The ambiguity is the problem.") | Replace with the concrete ask or constraint |
